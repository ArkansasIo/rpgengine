...
**Or on Linux/macOS:**create some blueprint and script amd 
...
For the engine architecture, UML, and Lua scripting guide, see [doc/ArcLight_Design_UML_Scripting.markdown](doc/ArcLight_Design_UML_Scripting.markdown).
