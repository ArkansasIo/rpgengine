...
private:
	...
	spring_time readyTime = ArcLight_notime;

	spring_time lastNewFrameTick = ArcLight_notime;
	spring_time lastPlayerInfo = ArcLight_notime;
	spring_time lastUpdate = ArcLight_notime;
	spring_time lastBandwidthUpdate = ArcLight_notime;
