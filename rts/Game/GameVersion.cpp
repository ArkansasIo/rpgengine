...
#ifndef ArcLight_VERSION_ENGINE
#define ArcLight_VERSION_ENGINE SPRING_VERSION_ENGINE
#define ArcLight_VERSION_ENGINE_MAJOR SPRING_VERSION_ENGINE_MAJOR
#define ArcLight_VERSION_ENGINE_PATCH_SET SPRING_VERSION_ENGINE_PATCH_SET
#define ArcLight_VERSION_ENGINE_COMMITS SPRING_VERSION_ENGINE_COMMITS
#define ArcLight_VERSION_ENGINE_HASH SPRING_VERSION_ENGINE_HASH
#define ArcLight_VERSION_ENGINE_BRANCH SPRING_VERSION_ENGINE_BRANCH
#define ArcLight_VERSION_ENGINE_ADDITIONAL SPRING_VERSION_ENGINE_ADDITIONAL
#define ArcLight_VERSION_ENGINE_RELEASE SPRING_VERSION_ENGINE_RELEASE
#endif
